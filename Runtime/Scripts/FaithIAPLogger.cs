namespace com.faith.iap
{
    ...
    public class FaithIAPLogger : MonoBehaviour
    {
		...
		private static FaithIAPConfiguretionInfo _apIAPConfiguretionInfo;
		...
		{
			_apIAPConfiguretionInfo = Resources.Load<FaithIAPConfiguretionInfo>("APIAPConfiguretionInfo");
		}
		...
		public static void Log(object message)
		{
			if (_apIAPConfiguretionInfo.ShowAPSdkLogInConsole)
			{
				Debug.Log(string.Format(
					"<color={0}>{1}{2}</color>",
					GetHexColorFromRGBColor(_apIAPConfiguretionInfo.InfoLogColor),
		...
		public static void LogWarning(object message)
		{
			if (_apIAPConfiguretionInfo.ShowAPSdkLogInConsole)
			{
				Debug.LogWarning(string.Format(
					"<color={0}>{1}{2}</color>",
					GetHexColorFromRGBColor(_apIAPConfiguretionInfo.WarningLogColor),
					"[" + FaithIAPConstant.Name + "]: ",
					message));
			}
		...
		public static void LogError(object message)
		{
			if (_apIAPConfiguretionInfo.ShowAPSdkLogInConsole)
			{
				Debug.LogError(string.Format(
					"<color={0}>{1}{2}</color>",
					GetHexColorFromRGBColor(_apIAPConfiguretionInfo.ErrorLogColor),
					"[" + FaithIAPConstant.Name + "]: ",
					message));
			}
